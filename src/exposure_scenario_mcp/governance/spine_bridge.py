...
# .../src/exposure_scenario_mcp/governance/spine_bridge.py -> repo root is parents[3].
...
def recognized_schema_ids() -> frozenset[str] | None:
    ...
    try:
        proc = subprocess.run(  # noqa: S603 — args are the vendored, digest-verified engine; not untrusted
