...
def defaults_evidence_map(registry: DefaultsRegistry | None = None) -> str:
    ...
    lines.extend(
        [
            ...
            "  the dermal `trigger_spray` transfer default of `1.0` when the modeled product",
            "  amount is interpreted as the skin-boundary amount for spray-contact screening.",
            "",
