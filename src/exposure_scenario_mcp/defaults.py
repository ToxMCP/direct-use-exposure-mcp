...
def defaults_evidence_map(registry: DefaultsRegistry | None = None) -> str:
    ...
    lines.extend(
        [
            ...
            "  workflow.",
            "- `nlm_dailymed_dietary_supplement_label_2025` anchors the same `direct_oral`",
            "  route-semantics branch for `dietary_supplement` when the workflow is a",
            "  labeled capsule or tablet regimen rather than dietary intake.",
