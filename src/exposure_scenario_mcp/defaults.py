...
def defaults_evidence_map(registry: DefaultsRegistry | None = None) -> str:
    ...
    lines.extend(
        [
            ...
            "",
            "- `heuristic_retention_defaults_v1` covers rinse-off and surface-contact retention",
            "  factors that remain screening heuristics pending better route- and use-specific",
            "  retention evidence.",
            "",
            "### Heuristic Transfer Defaults",
            "",
            "- `heuristic_transfer_efficiency_defaults_v1` covers dermal transfer efficiency",
            "  benchmarks for hand application, wiping, pouring, and spray-contact contexts.",
            "",
