...
- For remote HTTP, prefer shared bearer-token auth, an explicit origin allow-list for browser
  clients, and a request size limit even before you add gateway TLS or rate limiting.
